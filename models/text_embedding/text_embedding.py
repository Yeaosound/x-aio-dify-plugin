...
class XAllInOneTextEmbeddingModel(OAICompatEmbeddingModel):
    """
    Model class for XAllInOne text embedding model.
    """
    ...
    def _add_custom_parameters(cls, credentials: dict) -> None:
        credentials["endpoint_url"] = "https://api.x-aio.com/v1"
